...
def generate_frames():
    ...
    while True:
        ...
        if camera is None or not camera.isOpened():
            ...
            cv2.putText(annotated_frame, f"SPEED: {speed} km/h", (30, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            cv2.putText(annotated_frame, f"SWING: {swing}px", (30, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
            cv2.putText(annotated_frame, f"SPIN/CURVE: {spin}", (30, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
